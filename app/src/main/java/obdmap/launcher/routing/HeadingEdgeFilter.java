...
public final class HeadingEdgeFilter implements EdgeFilter {
    ...
    public boolean accept(EdgeIteratorState edgeState) {
        ...
        for (int i = 0; i < n - 1; i++) {
            double distSq = segmentDistSq(geom.getLat(i), geom.getLon(i),
     ...
     */
    private double segmentDistSq(double aLat, double aLon, double bLat, double bLon, double cosLat) {
