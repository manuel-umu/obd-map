...
/**
 * Pantalla de ajustes Bluetooth del escaner OBD
 */
public final class ObdBluetoothActivity extends AppCompatActivity {
    private static final String ELM327_DEFAULT_PIN = "1234";
    private ActivityObdBluetoothBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = ActivityObdBluetoothBinding.inflate(getLayoutInflater());
    ...
    // Prioridad alta para suprimir el diálogo del sistema
